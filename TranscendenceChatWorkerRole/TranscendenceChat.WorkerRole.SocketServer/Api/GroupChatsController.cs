...
using TranscendenceChat.ServerClient.Ws.Requests;
...
using ClientDto = TranscendenceChat.ServerClient.Ws;
using GroupChatParticipant = TranscendenceChat.ServiceBusShared.Entities.GroupChatParticipant;
