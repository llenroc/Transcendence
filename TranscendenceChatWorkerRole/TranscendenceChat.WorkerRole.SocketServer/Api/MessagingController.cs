...
using TranscendenceChat.WorkerRole.SocketServer.Api.Base.EventManagement;
...
using ClientDto = TranscendenceChat.ServerClient.Entities.Ws;
using DeliveryNotification = TranscendenceChat.ServiceBusShared.Entities.DeliveryNotification;
using SeenNotification = TranscendenceChat.ServiceBusShared.Entities.SeenNotification;

namespace TranscendenceChat.WorkerRole.SocketServer.Api
{
