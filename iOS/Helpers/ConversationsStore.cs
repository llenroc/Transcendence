...
namespace TranscendenceChat.iOS
{
	public static class ConversationsStore
	{
		static string GetJSONPath (string outputFile)
		{
			...
			var appGroupContainer = FileManager.GetContainerUrl ("group.com.xamarin.Transcendencechat.security");
			if (appGroupContainer == null) {
				Console.WriteLine ("You must create the app group: \"group.com.xamarin.Transcendencechat.security\" in order to run the project.");
			} else {
