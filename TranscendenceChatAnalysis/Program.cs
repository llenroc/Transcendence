...
namespace TranscendenceChatAnalysis
{
	class Program
	{
			...
			var projects = new List<Solution> {
				...
				new Solution {
					...
					ProjectFiles = new List<string> {
						Path.Combine(path, "" + "../Android/TranscendenceChat.Android.csproj"),
						Path.Combine(path, "../TranscendenceChat.ServerClient/TranscendenceChat.ServerClient.csproj"),
				...
				new Solution {
					Name = "iOS",
					ProjectFiles = new List<string> {
						Path.Combine(path, "../iOS/TranscendenceChat.iOS.csproj"),
						Path.Combine(path, "../TranscendenceChat.ServerClient/TranscendenceChat.ServerClient.csproj"),
						Path.Combine(path, "../SharedClient/SharedClient.csproj")
					},
				},
				...
				new Solution {
					Name = "Server",
					ProjectFiles = new List<string> {
						Path.Combine(path, "../TranscendenceChatServer/TranscendenceChatServer.csproj"),
						Path.Combine(path, "../TranscendenceChat.ServerClient/TranscendenceChat.ServerClient.csproj")
					},
				},
