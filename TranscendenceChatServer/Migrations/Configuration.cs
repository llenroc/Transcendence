...
namespace TranscendenceChatServer.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TranscendenceChatServer.DAL.ApplicationDbContext>
    {
        ...
        protected override void Seed(TranscendenceChatServer.DAL.ApplicationDbContext context)
        {
