...
using TranscendenceChatServer.Core.EmailNotifications;
using TranscendenceChatServer.DAL;
using TranscendenceChatServer.Models;
using TranscendenceChatServer.Providers;
using TranscendenceChatServer.Results;
    ...
    public class UsersController : ApiController
    {
        ...
        private JsonUser CreateReturnUserObject(User user)
        {
            ...
            return new JsonUser
            {
                ...
                TranscendencePoints = user.TranscendencePoints,
                TranscendenceStatus = user.TranscendenceStatus,
                Sms = user.Sms,
