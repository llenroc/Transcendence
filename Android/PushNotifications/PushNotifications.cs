...
namespace TranscendenceChat
{
	...
	[IntentFilter(new [] { Constants.INTENT_FROM_GCM_LIBRARY_RETRY },
		Categories = new [] { "@PACKAGE_NAME@" })]
	public class TranscendenceGcmBroadcastReceiver : GcmBroadcastReceiverBase<TranscendenceGcmService>
	{
	...
	public class TranscendenceGcmService : GcmServiceBase
	{
		...
		public static void Register(Context context)
		{
            ...
            GcmClient.Register (context, TranscendenceGcmBroadcastReceiver.SenderIds);
		}

		public TranscendenceGcmService() : base(TranscendenceGcmBroadcastReceiver.SenderIds)
		{
		}
