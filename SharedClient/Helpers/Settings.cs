...
namespace TranscendenceChat
{
	...
	public static class Settings
	{
		...
		const string TranscendencePointsPendingKey = "points_pending_key";
		...
		public static int TranscendencePointsPending
		{
			get
			{
				return GetValueOrDefault(TranscendencePointsPendingKey, TranscendencePointsPendingDefault);
			}
			set
			{
				AddOrUpdateValue (TranscendencePointsPendingKey, value);
			}
		}
		...
		public static int TranscendencePoints
		{
			get
			{
				return GetValueOrDefault(TranscendencePointsKey, TranscendencePointsDefault);
			}
			set
			{
				AddOrUpdateValue (TranscendencePointsKey, value);
			}
		}
		...
		public static Task Logout()
		{
			...
			AccessToken = string.Empty;
			TranscendencePoints = 500;
			TranscendencePointsPending = 0;
