using System;
using TranscendenceChat;
using System.Collections.Generic;
using System.Threading.Tasks;
using System.Linq;
using System.Threading;
using TranscendenceChat.Helpers;
using TranscendenceChat.Models;
...
namespace TranscendenceChat
{
	public interface IDataManager
	{
		...
		Task<List<TranscendenceTask>> GetTranscendenceTaskAsync ();
		Task AddOrSaveTranscendenceTaskAsync (TranscendenceTask item);
	}

	public class DataManager : IDataManager, IMessageRepository
	{
        readonly TranscendenceDatabase database;
        readonly SemaphoreSlim semaphore = new SemaphoreSlim(1);

		public DataManager()
		{
			database = new TranscendenceDatabase ();
		}
		...
		public Task<List<TranscendenceTask>> GetTranscendenceTaskAsync ()
		{
			return database.GetItemsAsync<TranscendenceTask> ();
		}

		public Task AddOrSaveTranscendenceTaskAsync (TranscendenceTask item)
		{
