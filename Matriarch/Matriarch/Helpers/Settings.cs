...
namespace Matriarch.Helpers
{
	...
	public static class Settings
	{
		...
		const string TranscendencePointsPendingKey = "Transcendence_points_pending_key";
		static readonly int TranscendencePointsPendingDefault = 0;

		const string TranscendencePointsKey = "Transcendence_points_key";
		static readonly int TranscendencePointsDefault = 500;
		...
		public static int TranscendencePointsPending
		{
			get
			{
				return AppSettings.GetValueOrDefault(TranscendencePointsPendingKey, TranscendencePointsPendingDefault);
			}
			set
			{
				AppSettings.AddOrUpdateValue(TranscendencePointsPendingKey, value);
			}
		}

		public static int TranscendencePoints
		{
			get
			{
				return AppSettings.GetValueOrDefault(TranscendencePointsKey, TranscendencePointsDefault);
			}
			set
			{
				AppSettings.AddOrUpdateValue(TranscendencePointsKey, value);
			}
		}
